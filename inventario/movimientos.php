...
<style>
    body {
        /* Fondo con imagen y capa de transparencia */
...
<div class="glass-container">
    ...
    $sql = "SELECT m.*, med.nombre as medicamento 
            FROM movimientos m 
            ...
            <?php if (count($movimientos) > 0): ?>
                <?php foreach ($movimientos as $mov): ?>
                    <tr>
                        ...
                        <td style="font-style: italic; color: #555;"><?= htmlspecialchars($mov['observacion'] ?? '-') ?></td>
                    </tr>
                <?php endforeach; ?>
            <?php else: ?>
                <tr>
